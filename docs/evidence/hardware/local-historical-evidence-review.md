...
| S5 fresh ReBrewie runtime | Direct dated evidence already recorded with exact path/hash/ranges: lines 10-11/108 in [HW-101](facts/HW-101.md), 96-102 in [HW-102](facts/HW-102.md), 70-95/355-381 in [HW-103](facts/HW-103.md), 282-297/424-582 in [HW-104](facts/HW-104.md), and 221-225 in [HW-108](facts/HW-108.md). | Verifies only those scoped runtime observations; not factory-userspace, fitted-part, wiring, or electrical evidence. |
...
| S6 fresh Olimex/Debian runtime | Direct dated evidence already recorded with exact path/hash/ranges: lines 334-348 in [HW-007](facts/HW-007.md)/[HW-008](facts/HW-008.md), 1-11/36 in [HW-105](facts/HW-105.md), 138 in [HW-106](facts/HW-106.md), 214-219/342-349/358-365 in [HW-107](facts/HW-107.md), and 123-126 in [HW-108](facts/HW-108.md). | Verifies only the scoped runtime observations; physical identities and future choices remain separate. |
