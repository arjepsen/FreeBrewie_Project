...
| Modern experimental runtime | The fresh 2026-08-12 Olimex/Debian experiment records kernel, architecture, model, Linux memory accounting, an enabled A13 watchdog, and runtime enumeration/use of a Realtek USB WLAN device. [HW-105](facts/HW-105.md) [HW-106](facts/HW-106.md) [HW-107](facts/HW-107.md) | verified dated observations; physical fitment remains unverified |
