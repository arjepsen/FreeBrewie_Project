...
| Touchscreen | Goodix-family controller candidate on SOM I2C bus 2, address `0x14`. | I2C candidate. [HW-007](facts/HW-007.md) [HW-008](facts/HW-008.md) | Exact part, pull-ups, voltage, carrier routing, interrupt, and reset unknown. | disputed |
